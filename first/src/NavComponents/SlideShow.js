...
const SlideShow = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={{ position: 'relative', zIndex: 2, fontFamily: "Roboto, sans-serif", fontWeight: 400, marginBottom: '20px', fontSize: '20px', textAlign: 'right', marginLeft: '300px' }}>
        <h3 style={{ marginTop: '-40px', letterSpacing:'2px', textTransform: 'uppercase', lineHeight: '1.2' }}> {/* Adjusting the margin top */}
          DEDICATED TO<br />EDUCATING AND<br />EMPOWERING WOMEN
        </h3>
        <div className="animation" style={{ marginTop: '-10px', letterSpacing:'2px', position: 'relative', fontFamily: "Roboto, sans-serif", fontWeight: 300, fontStyle: 'italic', textAlign: 'right', wordWrap: 'break-word' }}>
